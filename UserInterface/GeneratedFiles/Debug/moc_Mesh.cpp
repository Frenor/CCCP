...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Mesh_t, stringdata) + ofs \
...
const QMetaObject Mesh::staticMetaObject = {
    { &Entity::staticMetaObject, qt_meta_stringdata_Mesh.data,
      qt_meta_data_Mesh,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Mesh.stringdata))
