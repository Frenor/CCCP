...
TriangleElement::TriangleElement() : Element()
{
	this->type = Element::TRIANGLE;
}

void TriangleElement::calculateAreaCentre()
{
	ecx = (x1 + x2 + x3) / 3;
	ecy = (y1 + y2 + y3) / 3;
...
void TriangleElement::calculateArea()
{
	//MatrixXd J(2,2);
...
double TriangleElement::getSecondAreaMomentX(double Ay)
{
...
double TriangleElement::getSecondAreaMomentY(double Ax)
{
	double weight[3] = { 1.0 / 3, 1.0 / 3, 1.0 / 3 };
	double xg[3] = { 2.0 / 3, 1.0 / 6, 1.0 / 6 };
	double yg[3] = { 1.0 / 6, 2.0 / 3, 1.0 / 6 };
...
double TriangleElement::getSecondAreaMomentProduct(double Ax, double Ay)
{
	double weight[3] = { 1.0 / 3, 1.0 / 3, 1.0 / 3 };
	double xg[3] = { 2.0 / 3, 1.0 / 6, 1.0 / 6 };
	double yg[3] = { 1.0 / 6, 2.0 / 3, 1.0 / 6 };
